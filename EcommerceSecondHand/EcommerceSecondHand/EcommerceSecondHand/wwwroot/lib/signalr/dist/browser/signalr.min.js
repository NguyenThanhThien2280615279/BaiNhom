        ...
        (() => {
            ...
            class w {
                ...
                static isNotEmpty(t, e) {
                    if (!t || t.match(/^\s*$/))
                        throw new Error(
                            `The '${e}' argument should not be empty.`
                        );
                }
                static isIn(t, e, s) {
            ...
            (D.RecordSeparatorCode = 30),
                (D.RecordSeparator = String.fromCharCode(
                    D.RecordSeparatorCode
                ));
            class R {
            ...
            class L {
                ...
                W(t) {
                    if (this.P)
                        return t.type === x.Sequence && ((this.P = !1), !0);
                ...
                X(t) {
                    null != t ||
                        (t = new Error("Unable to reconnect to server."));
                            ...
                            i
                                ...
                                : s &&
                                  (s.type === x.Completion
                                      ...
                                      : e(
                                            new Error(
                                                `Unexpected message type: ${s.type}`
                                            )
                                        ));
                        };
                                ...
                                switch (t.type) {
                                    case x.Invocation:
                                        this.Wt(t).catch((t) => {
                                            this.u.log(
                                                e.Error,
                                                `Invoke client method threw error: ${P(
                                                    t
                                                )}`
                                            );
                                        });
                        ...
                        try {
                            ...
                            if (
                                ...
                                return (
                                    ...
                                    void (
                                        this.ut === A.Disconnecting && this.Dt()
                                    )
                                );
                            (n =
                                t instanceof Error
            ...
            class O extends d {
                ...
                async send(t) {
                    ...
                    this.Yt &&
                        (!this.Zt ||
                            (t.url && t.url.indexOf("/negotiate?") > 0)) &&
            ...
            class J {
                ...
                async connect(t, s) {
                    ...
                    this.u.log(
                        e.Trace,
                        `(LongPolling transport) polling: ${c}.`
                    );
            ...
            class K {
                ...
                send(t) {
                    return "Connected" !== this.ut
                        ...
                        : (this.Ee || (this.Ee = new G(this.transport)),
                          this.Ee.send(t));
                }
                async stop(t) {
                ...
                async yt(t) {
                    ...
                    try {
                        ...
                        return (
                            this.u.log(
                                e.Error,
                                "Failed to start the connection: " + t
                            ),
                            (this.ut = "Disconnected"),
                            (this.transport = void 0),
                            this.me(),
                ...
                Re(t, s, i, n) {
                    ...
                    if (
                        ...
                        return (
                            ...
                            new o(
                                `'${F[r]}' is not supported in your environment.`,
                                r
                            )
                        );
                ...
                Ie(t) {
                    ...
                    return (
                        ...
                        s.has("useStatefulReconnect")
                            ? "true" === s.get("useStatefulReconnect") &&
                              (this.ie._e = !0)
                            : !0 === this.ie._e &&
                              s.append("useStatefulReconnect", "true"),
                        (e.search = s.toString()),
                        e.toString()
                    );
                }
            ...
            class G {
                ...
                static We(t) {
                    ...
                    let i = 0;
                    for (const e of t)
                        s.set(new Uint8Array(e), i), (i += e.byteLength);
                    return s.buffer;
                }
            }
            class Q {
            ...
            class tt {
                configureLogging(t) {
                    if ((w.isRequired(t, "logging"), void 0 !== t.log))
                        this.logger = t;
                ...
                withHubProtocol(t) {
                    return (
                        w.isRequired(t, "protocol"), (this.protocol = t), this
                    );
                }
                ...
                build() {
                    ...
                    if (
                        (void 0 === t.logger && (t.logger = this.logger),
                        !this.url)
                    )
                        throw new Error(
                    ...
                    Object.defineProperty(Uint8Array.prototype, "slice", {
                        value: function (t, e) {
                            return new Uint8Array(
                                Array.prototype.slice.call(this, t, e)
                            );
                        },
                        writable: !0,
                    }),
