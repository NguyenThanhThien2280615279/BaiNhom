        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevenueLast30Days = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NewUsersLast30Days = table.Column<int>(type: "int", nullable: false),
                    ...
                    ProductsPerCategory = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VnPayResponseCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    VnPayResponseMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    VnPaySecureHash = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RechargeTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RechargeTransactions_RechargePackages_RechargePackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalProductsListed = table.Column<int>(type: "int", nullable: false),
                    ...
                    TotalPurchasesAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalReviewsReceived = table.Column<int>(type: "int", nullable: false),
                    AverageRatingReceived = table.Column<double>(type: "float", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MonthlySpending = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MonthlyRevenue = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_LastMessageId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RechargeTransactions_RechargePackageId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Messages_LastMessageId",
                table: "AspNetUsers",
                column: "LastMessageId",
