...
namespace EcommerceSecondHand.Repositories
{
    public class NotificationRepository : INotificationRepository
    {
        ...
        public async Task<IEnumerable<Notification>> GetPaginatedNotificationsAsync(string userId, NotificationType? type, bool unreadOnly, int page, int pageSize)
        {
        ...
        public async Task<int> GetNotificationsCountAsync(string userId, NotificationType? type, bool unreadOnly)
        {
            var query = _context.Notifications.Where(n => n.UserId == userId);
